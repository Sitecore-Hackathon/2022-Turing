...
namespace Mvp.Feature.Reviews.Rendering.Models
{
    ...
    public class SubmissionsSearchResults
    {
    ...
    public class ApplicationsSearch
    {
        public List<Facet> facets { get; set; }
    ...
    {
        public ApplicationsSearch Search { get; set; }
    }
