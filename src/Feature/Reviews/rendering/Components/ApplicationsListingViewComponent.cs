...
{
    public class ApplicationsListingViewComponent : ViewComponent
    {
        private readonly IGraphQLReviewsService _graphQLReviewsService;

        public ApplicationsListingViewComponent(IGraphQLReviewsService graphQLReviewsService)
        {
            _graphQLReviewsService = graphQLReviewsService;
        }

        public async Task<IViewComponentResult> InvokeAsync()
        {
            var searchParams = _graphQLReviewsService.CreateSearchParams();
            ...
            var results = await _graphQLReviewsService.Search(searchParams);
