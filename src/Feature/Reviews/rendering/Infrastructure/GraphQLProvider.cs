...
namespace Mvp.Feature.Reviews.Infrastructure
{
    public class GraphQLProvider :  IGraphQLProvider
    {
        ...
        private readonly ReviewsClientFactory _graphQLClientFactory;
        private readonly bool _isDevelopment;

        public GraphQLProvider(ILogger<IGraphQLProvider> logger, GraphQLRequestBuilder graphQLRequestBuilder, ReviewsClientFactory graphQLClientFactory)
        {
            _logger = logger;
